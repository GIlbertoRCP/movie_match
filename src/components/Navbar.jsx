...
export default function Navbar() {
  ...
  return (
    <>
      <header className="sticky top-0 z-30 w-full bg-[#080a0f]/85 backdrop-blur-xl border-b border-slate-800/60 px-4 py-3">
        <div className="max-w-4xl mx-auto flex items-center justify-between gap-3">
          {/* Logo & Title */}
          <div className="flex items-center gap-2.5 cursor-pointer group" onClick={() => resetSession()}>
            <div className="w-9 h-9 rounded-xl bg-slate-900 border border-amber-500/30 p-0.5 shadow-lg shadow-amber-950/20 flex items-center justify-center transition-transform group-hover:scale-105">
              <Film className="w-4 h-4 text-amber-300" />
            </div>
            <div>
              <h1 className="text-base font-extrabold tracking-tight text-white flex items-center gap-1.5">
                Movie Match
                <span className="px-1.5 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest bg-amber-500/10 text-amber-300 border border-amber-500/20">
                  PRO
                </span>
              </h1>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="p-2 rounded-xl bg-amber-500/10 text-amber-300 hover:bg-amber-500/20 border border-amber-500/30 transition-all shadow-md shadow-amber-950/20"
            ...
            >
              {isAuthenticated ? <UserCheck className="w-4 h-4 text-emerald-400" /> : <User className="w-4 h-4 text-slate-300" />}
            </button>
            ...
            <button
              ...
              className={`p-2 rounded-xl transition-all border ${
                isCustomActive
                  ? 'text-indigo-300 border-indigo-500/50 bg-indigo-950/40 shadow-lg'
                  : 'text-slate-300 hover:text-white bg-slate-900/60 border-slate-800'
              }`}
            ...
            <button
              ...
              className="p-2 rounded-xl bg-slate-900/60 text-slate-300 hover:text-white hover:bg-slate-800 transition-all border border-slate-800"
            ...
            <button
              ...
              className="p-2 rounded-xl bg-slate-900/60 text-slate-400 hover:text-rose-400 hover:bg-rose-950/30 hover:border-rose-800/40 transition-all border border-slate-800"
